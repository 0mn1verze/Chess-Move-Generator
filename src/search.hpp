...
private:
  ...
  void updateHistory(const Position &pos, Move history, Depth depth);
  void updateButterfly(const Position &pos, Move history, Depth depth);
