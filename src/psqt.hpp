...
// Piece Values (https://www.chessprogramming.org/PeSTO%27s_Evaluation_Function)
constexpr Score pieceVal[PIECE_TYPE_N] = {
    _S(0, 0),     _S(82, 94),    _S(337, 281),    _S(365, 297),
    _S(477, 512), _S(1025, 936), _S(10000, 10000)
};

// Game Phase table
constexpr int gamePhaseInc[PIECE_TYPE_N] = {0, 0, 1, 1, 2, 4, 0};

// Piece-Square Tables
constexpr Score psqTable[PIECE_TYPE_N][SQ_N] = {
    {}, // Empty
    {
